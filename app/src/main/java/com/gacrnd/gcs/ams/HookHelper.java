...
public class HookHelper {
                    ...
                    , new InvocationHandler() {
                        ...
                        public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
                            ...
                            if ("startActivity".equals(method.getName())) {
                                ...
                                newIntent.setComponent(new ComponentName("com.gacrnd.gcs.ams", SubActivity.class.getName()));
    ...
    /**
     * 一般hook都hook 静态的或者public的，这样一般对象不会被改变
     */
    public static void hookIActivityManager() {
        ...
        try{
            ...
            //是private的，设置可访问
            singletonField.setAccessible(true);
            //由于IActivityManager外层包裹了一个Singleton，对应的mInstance就是IActivityManager
            Object singleton = singletonField.get(null);
            //拿IActivityManager对象
...
//                            Log.i(TAG, "invoke: " + method.getName());
                            ...
                            Intent raw = null;
                            int index = -1;
                            //遍历调用的方法中有startActivity的方法就先设置一个真实的Activity去验证
                            if ("startActivity".equals(method.getName())) {
                                Log.i(TAG, "invoke: startActivity 启动准备");
                                for (int i = 0; i < args.length; i++) {
                                    if(args[i] instanceof  Intent){
                    ...
                    switch (msg.what) {
                        ...
                        case 159: {
                            ...
                            try {
                                ...
                                //注意了 这里如果debug调试会发现第一次size=0 原因如下
                                //在Android O之前
